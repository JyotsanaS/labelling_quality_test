...
images_patt = "/home/ubuntu/home/ubuntu/6channel_training/dataset_tiles/satsure_large_rgb_jpg/images/*"

df_base = pd.read_json('/home/ubuntu/home/ubuntu/6channel_training/embeddings_dinov2/embeddings_satsure_tiles_base-model_large_jpg.json')
df_finetuned = pd.read_json('/home/ubuntu/home/ubuntu/6channel_training/embeddings_dinov2/embeddings_satsure_tiles_finetune-model-99_large_jpg.json')
...
# Create dataset
dataset_base = fo.Dataset("satsure_6channel_large_dataset")
...
results_base = fob.compute_visualization(
    ...
    num_dims=2,
    method="umap",
    brain_key="satsure_6channel_large_base",
    verbose=True,
    seed=51,
)
...
results_embeddings = fob.compute_visualization(
    ...
    num_dims=2,
    method="umap",
    brain_key="satsure_6channel_large_finetuned_99",
    verbose=True,
    seed=51,
)
...
if __name__ == "__main__":
    ...
    session = fo.launch_app(dataset_base, port=5152)
